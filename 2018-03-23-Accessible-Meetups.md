...
**[Dennis]:** So, my question to you ... you didn't actually create or start the Toronto meetup, but how did you get started with it?
...
**[John Croston III]:** Thank you, sir.
...
**[Dennis]:**  The one thing I will say is, you might feel relieved once you've found a venue, but please make sure they're accessible. Go, actually do a scouting and check it out. Make sure that they offer all the facilities for accessibility. Make sure they have good audio, visual equipment. Funny enough, right now, one of our requirements is, we need to have two screens, two monitors. One for the presentation, one for live captions. We'll get into it later, but we live stream everything. So we provide live captioning along with our event. And yes, of course, good Wi-Fi. I'm actually finding that that is more difficult than I would have thought. You want to make sure that, obviously, the presenter needs Wi-Fi. If you're doing something special with live captioning, you might need a separate network for that, a good, fast network for that. And also consider your participants, your attendees, who might need Wi-Fi, let's say, if they're accessing live  So, definitely want to look at those as you look at venues for your meetup.

## Speakers

**[Billy]:** This is a fun one. So we took a different approach in Toronto last year. We actually put together a curriculum, and then we started thinking about who would be best to deliver on that specific topic. So we sort of planned our year, decided which topics we wanted, and then sort of approached people on that. 

Now there's always going to be someone who's coming through town. Like if a Lainey Feingold comes through your town, you drop everything and you set up a meetup because you know you're going to get 200 people out for that. So, there's the special guest, for the most part, like if Adrian's coming through town, that's a good 15 people right there.

**[Laughter]**

**[Comments from the audience]**

**[Billy]:** So we can book like the public restroom or something for him ...

**[Laughter]**

**[Billy]:** But its ... there's always special events that we do. At Toronto, we're a big social town, we love our social events. If we book a social event at a bar, on a days notice, we'll fill it. I guess Canadians just love their beer. But we're really fortunate ... [indecipherable] Finding speakers, we approach ... we're shameless ...

**[Dennis]:** It's funny because, actually, two years ago, is when I discovered that, having well-known speakers, traveling through your city. Derek Featherstone was the first individual. He was speaking at An Event Apart. I shamelessly just said, "Hey, while you're in town, can you speak at our meetup." And he said, "Sure." I've had the same thing happen with Lainey. And with Marcy Sutton. It's great. But it also doesn't stop with in-person speakers. We've had Laura Kalbag from Sweden present remotely. So, you are in a locale that doesn't get the celebrities if you want to say, coming through town, always consider going the remote route.

Yes?

**[Attendee]:** Hi, I'm from Dallas, and my friend and I are wanting to start a meetup. Do speakers expect monetary ... ?

**[Billy]:** We've never had anyone ask us for money. I think, most of the time, folks know that if their coming to speak at a small meetup group, there's not going to be money. Best case, you take them out to dinner afterwards.

**[Dennis]:** And I have to get good at actually buying them a beer afterwards. I'm typically the first one out, catching the train. I need to get better. So, yes, very good question on that.

I've actually toyed with ... if we got enough sponsorship, maybe there would be some nominal payment. I think that would be more valuable for our local speakers. To say, "Thanks for all the effort you put into this." And then, I think, you know, obviously, you have your celebrity speakers, your local speakers I am very much looking at taking individuals from our meetup who I know have skills, knowledge and experience, and trying to encourage them, almost mentoring them to speak at our meetups. Just this year, I have already picked out four individuals who I've said, "I want you to work on something." "I want you to work on something for later this year." Because I think it does resonate well with the attendees, that someone in their midst, look what they're doing. And that might actually create more connections and networking to share their knowledge.

## Formats
**[Dennis]:** Ok, Formats.

**[Billy]:** These are fun. We have a few different formats in Toronto. We generally stick with either a social event, so there is no speaker whatsoever, we just take over a top floor of a pub, and we just network and socialize, we have our one speaker-type meetup, where they come and present on something, and then, interestingly enough, our two biggest events of the year, I don't now why, the two biggest events that we always have is, we always kick off the year with sort of an introductory, sort of accessibility 101 panel, that's always rammed. And then for some reason, the week after CSUN, we usually do a CSUN wrap-up. And that was always rammed as well. And those are general panels. And then literally anything with the letters UX in it.

**[Dennis]:** Yeah, what is it with UX?

**[Billy]:** I don't know.

**[Dennis]:** It's funny. Presentations have worked well for us. Because I have a sort of training and awareness mindset, that's the direction I've normally gone in. But I am looking, and we're talking about keeping it fresh in a little bit here, we are looking to mix it up. I know for Global Accessibility Awareness Day, to your point, having a speed dating format, we're looking at having an empathy event, where we'll have groups of individuals with various disabilities and groups of attendees will visit these stations, the verbiage here is off the top of my head, we haven't fully planned it out yet. But basically, attendees would interact with individuals with disabilities and learn about how their work, their thinking impacts those individuals. And after ten, fifteen minutes, whistle blows, people switch stations. And, there's been a lot of excitement within our organizers of this event. So, I'm looking to see how that plays out.

**[Billy]:** That sounds good.

**[Dennis]:** Demonstrations I have down here. I know next month, we're looking ... So, screen readers are actually very popular, but most people are not aware of other assistive technology. So we're having an event where, we're doing two different demos. One of them is for refreshable braille display, which most of our membership is completely unaware of. But then, hopefully this works out, we're having someone come in and to discuss assistive technology for individuals with cognitive disabilities. Jamie Knight said he would remote in, and now he's talking he might actually be in town I'm like, "you gotta be kidding me." So I'm trying to keep my enthusiasm down, because if that all comes about, I will be a kid in a candy store.
...
**[Billy]:** You can snicker, but the logic behind this is, on the pro wrestling circuit, if you have a big name wrestler, and you wanted to bring them to your event, what you would do is find other promoters in cities close by, and you would share in that initial travel cost. So, you get four or five meetups that are close together, and then you can pay the cost of flights or whatever to bring this person over. So that's another option; if you know someone coming through town, if Jamie was coming to Chicago, then I might think about flying him up to Toronto, because it's only an hour or so by plane, we could split some of the costs or whatever. So, there's always options to sort of share, split costs between sister cities. If you're running in Dallas, I know that Austin has a group, which isn't that far away.
...
**[Billy]:** Literally, I am just ruthless when it comes to begging for money. I call in every favor. Anybody I ask, they get added to our meetup mailing list. Johnny Taylor, you've probably seen him in a couple of slide decks this week, in my talk, in Heni's talk, he actually looks after a lot of our sponsorship stuff. So he's the guy, just at home, spamming people ... and it's not spam, these are personal, boilerplate emails that we send out to everybody. It's got everyone's name on it, not just *[name]* in brackets or anything. But we're pretty ruthless about it. We call in favors. 

We have sort of an attractive tiered sponsorship. And that's one thing that worked well for us. We introduced sponsorship tiers a couple of years ago. Just as a ... maybe it would work. And people loved it. The sponsors saw more value in that, because they got more space, there was more perks, we added different value options or value adds as you went up a level. And we run pretty big events. On average, get about 60 or 70 people out for each meetup that we have host. Socials are about 50 to 60. We have a yearly camp that we bring, well, we ... 300 people and this we'll tell you in a slide later,  300 people signup but 200 people show. No shows are something you'll just need to deal with when you're running a meetup group. And then now we have conference too. So we sort of introduced, instead of "hey sponsor this event' or "sponsor camp," we have "sponsor a11yTO for the year, and you're going to get all of this.
...
**[Attendee]:** A coupe of things that have worked very well, one ties back to the venue. My agency hosts the Detroit UX Meetup ... [indecipherable]
...
**[Attendee]:** So, I am a member of Accessibility Meetup groups and the Detroit UX meetup groupn ... and when host, when my agency hosts meetups, the agency itself offers swag, so there's cool stuff sitting around for people to have. The really valuable one though is O'Reilly Publishers and Rosenfeld Media both have user group chapters, that they provide free books for. So you can get e-books and physical books to give away at events.

**[Dennis]:** Actually, that's a good point. I have done that with A Book Apart as well. Rosenfeld Media is one of our sponsors and they offer us a discount, as well as books, free books for special occasions. The only thing I am going to say about sponsors is ... we're planning ... we're working on a day-long accessibility camp in Chicago for the first time this year.

**[Billy]:** Whoo!

**[Applause]**

**[Dennis]:** But, and I am not a sponsor ... unlike Billy, I am not one to go out there and say "please give us money." But, I personally feel, if you can show the benefit and the value to the sponsor, it's easier than you may think. So, just consider and think about that.

Yes, and wait one moment, I just want to make sure you can be heard by everyone.

**[Audience member]:** So, both of you talked about providing value to the sponsors, and sponsorship tiers, Billy. Can you be more specific about the kinds of benefits that you offer to sponsors?

**[Billy]:** Yes, so, as a small meetup site, camp, conference, whatever, we don't have a lot to offer, other than, visibility. So, certain levels of sponsorship might get you on all of our printed materials that we hand out. It would be on our website. Social media callouts. The frequency and number. Whether or not you have access to our database afterwards. Not to ... no to, we never give away our information. But we will include a message from a sponsor in a wrap-up email or something. We will never allow the sponsors direct access to our members, because that's just gross. But we will definitely pass along any messages. So its really just, figure out what value you can offer them, and then just multiply that offering by how ever many tiers you want to give up.

**[Dennis]:** Exactly.

We have 5 more minutes. So ... I'm sorry, one more question, and then we have to move on.

**[Audience member]:** I want to know about, how often to you communicate via email with your membership, and what types of email you send out?
